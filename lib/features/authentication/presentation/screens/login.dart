...
class _LoginPageState extends State<LoginPage> {
  ...
  void _getLastEmailLogin() async {
    LoginState? getLastEmailToLoginStateResponse =
        await loginViewModel.getLastEmailToLogin();
  ...
  Future<void> _submit() async {
    if (_formKey.currentState?.validate() ?? false) {
      _activeLoader();
      LoginState doLoginState = await loginViewModel.doLogin(
          email: _emailController.text, pin: _pinController.text);
